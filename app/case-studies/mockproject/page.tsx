...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="rounded-lg border border-indigo-100 bg-indigo-50/50 p-5 dark:border-indigo-500/20 dark:bg-indigo-500/5">
  ...
  return (
    <div className="px-6 py-12 sm:px-10 sm:py-16">
      ...
      <Section title="An illustrative example">
        ...
        <pre className="mt-4 overflow-x-auto rounded-md bg-zinc-950 p-5 text-sm leading-6 text-zinc-100 dark:bg-black">
