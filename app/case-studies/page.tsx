      ...
      <div className="mt-12 flex flex-col gap-6">
        {caseStudies.map((cs) => (
          <Link
            ...
            className="group rounded-box border border-black/10 bg-white/80 p-6 backdrop-blur-sm transition-colors hover:border-indigo-300 hover:shadow-sm dark:border-transparent dark:bg-white/5 dark:hover:bg-white/10"
          >
