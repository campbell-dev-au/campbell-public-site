...
export default function Home() {
  return (
    <div className="px-6 py-12 sm:px-10 sm:py-16">
      <div className="relative overflow-hidden rounded-box">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link
              href="/case-studies"
              className="inline-flex items-center justify-center rounded-box border border-black/15 px-6 py-3 text-sm font-medium transition-colors hover:border-black/30 dark:border-white/20 dark:hover:border-white/40"
            >
              See my work
            </Link>
          </div>
      ...
      <section className="mt-24 rounded-box border border-indigo-100 bg-indigo-50/50 p-8 dark:border-indigo-500/20 dark:bg-indigo-500/5 sm:p-10">
