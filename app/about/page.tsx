  ...
  return (
    <div className="px-6 py-12 sm:px-10 sm:py-16">
      ...
      <div className="mt-8 lg:grid lg:grid-cols-[1fr_280px] lg:gap-12">
        ...
        <div className="mt-8 h-fit rounded-box border border-indigo-100 bg-indigo-50/50 p-5 dark:border-white/10 dark:bg-indigo-500/5 lg:mt-0">
            ...
            <div key={group.title}>
              ...
              <ul className="mt-3 flex flex-wrap gap-2">
                {group.items.map((item) => (
                  <li
                    key={item}
                    className="rounded-box border border-indigo-100 bg-indigo-50/50 px-3 py-1 text-sm text-indigo-900 dark:border-white/10 dark:bg-indigo-500/5 dark:text-indigo-200"
                  >
                    {item}
                  </li>
                ))}
