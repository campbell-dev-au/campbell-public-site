...
export default function AboutPage() {
  return (
    <div className="px-6 py-12 sm:px-10 sm:py-16">
      <div className="relative overflow-hidden rounded-box border border-black/10 bg-indigo-50/40 shadow-sm dark:border-transparent dark:bg-indigo-500/10">
        <div
          aria-hidden
      ...
      <div className="mt-8 lg:grid lg:grid-cols-[1fr_280px] lg:gap-12">
        ...
        <div className="mt-8 h-fit rounded-box border border-indigo-100 bg-indigo-50/50 p-5 dark:border-transparent dark:bg-indigo-500/10 lg:mt-0">
            ...
            <div key={group.title}>
              ...
              <ul className="mt-3 flex flex-wrap gap-2">
                {group.items.map((item) => (
                  <li
                    key={item}
                    className="rounded-box border border-indigo-100 bg-indigo-50/50 px-3 py-1 text-sm text-indigo-900 dark:border-transparent dark:bg-indigo-500/10 dark:text-indigo-200"
                  >
                    {item}
                  </li>
                ))}
