...
export default function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-3 rounded-lg border border-black/10 bg-white/80 p-6 backdrop-blur-sm transition-colors hover:border-indigo-300 hover:shadow-sm dark:border-white/10 dark:bg-zinc-950/60 dark:hover:border-indigo-400/40"
    >
