    ...
    <form onSubmit={handleSubmit} className="flex max-w-md flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          type="text"
          required
          className="rounded-box border border-black/15 bg-white/80 px-3 py-2 text-sm outline-none backdrop-blur-sm focus:border-indigo-500 dark:border-transparent dark:bg-white/5 dark:focus:border-indigo-400"
        />
      </div>
